 ...
 */
public abstract class SecondaryListAdapter<GVH, SVH extends RecyclerView.ViewHolder> extends
        RecyclerView
        ...
        if (itemStatus.getViewType() == ItemStatus.VIEW_TYPE_GROUPITEM) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    onSubItemClick((SVH) holder, itemStatus.getGroupItemIndex(), itemStatus
                            .getSubItemIndex());
